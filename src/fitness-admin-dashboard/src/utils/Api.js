class Api {
  ...
  static activateUser(userId) {
    return this.put(`/api/user/activate/${userId}`);
  }

  static deactivateUser(userId) {
    return this.put(`/api/user/deactivate/${userId}`);
  }
  ...
  static updateService(serviceId, service) {
    return this.put(`/booking-api/api/Services/${serviceId}`, service);
  }
